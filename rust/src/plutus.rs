...
fn build_conway_cost_models() -> csl::Costmdls {
    ...
    res.insert(
        ...
        &csl::CostModel::from(vec![
            100788i128, 420, 1, 1, 1000, 173, 0, 1, 1000, 59957, 4, 1, 11183, 32, 201305, 8356,
            4, 16000, 100, 16000, 100, 16000, 100, 16000, 100, 16000, 100, 16000, 100, 100, 100,
    ...
    res.insert(
        ...
        &csl::CostModel::from(vec![
            ...
            18848, 0, 1, 180194, 159, 1, 1, 158519, 8942, 0, 1, 159378, 8813, 0, 1, 107490, 3298,
