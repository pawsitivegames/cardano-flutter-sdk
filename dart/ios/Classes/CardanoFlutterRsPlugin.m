...
// Declare the Rust FFI symbols that Dart will locate via dlsym(RTLD_DEFAULT, ...).
// Referencing them here creates a hard linker dependency that prevents
// the linker from dead-stripping these symbols from the static library.
