...
> This file is read by Codex at the start of every session. Keep it under 200 lines.
...
**The plan:** see `docs/PLAN.md` (single source of truth). Critical review of stack choices in `.Codex/goals/CRITICAL_REVIEW.md`.
...
## Communication style preferences for Codex
